...
class FinanceTargetInput extends FormzInput<String, InputValidation> {
  const FinanceTargetInput.pure() : super.pure('');
  const FinanceTargetInput.dirty({String value = ''}) : super.dirty(value);
