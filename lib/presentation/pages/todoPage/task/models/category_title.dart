...
class CategoryTitle extends FormzInput<String, InputValidation> {
  const CategoryTitle.pure() : super.pure('');
  const CategoryTitle.dirty({String value = ''}) : super.dirty(value);
